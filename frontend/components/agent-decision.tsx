...
import { ArrowUpIcon, ArrowDownIcon, MinusIcon, Brain, TrendingUp, BarChart3, LineChart } from "lucide-react"
...
export default function AgentDecision({ stockSymbol, priceData, sentimentData }: AgentDecisionProps) {
  ...
  useEffect(() => {
    ...
    const avgSentiment = recentSentiments.reduce((sum, sentiment) => sum + sentiment, 0) / recentSentiments.length
    ...
    const weightedPrediction =
      meanReversionPrediction * weights.meanReversion * meanReversionConfidence +
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Analysis and recommendations for {stockSymbol}</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="md:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card>
              ...
              <CardContent className="py-1">
                <div className="flex justify-between items-center mb-2">
                  <div>{getPredictionBadge(agentPredictions.meanReversion.prediction)}</div>
                ...
                <div className="space-y-1">
                  ...
                  <Progress value={agentPredictions.meanReversion.confidence * 100} />
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="py-1">
                <div className="flex justify-between items-center mb-2">
                  <div>{getPredictionBadge(agentPredictions.momentum.prediction)}</div>
                  <div className="text-sm text-muted-foreground">Weight: {(weights.momentum * 100).toFixed(0)}%</div>
                </div>
                <div className="space-y-1">
                  <div className="text-sm">Confidence</div>
                  <Progress value={agentPredictions.momentum.confidence * 100} />
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="py-1">
                <div className="flex justify-between items-center mb-2">
                  <div>{getPredictionBadge(agentPredictions.sentimentMomentum.prediction)}</div>
                  <div className="text-sm text-muted-foreground">
                ...
                <div className="space-y-1">
                  <div className="text-sm">Confidence</div>
                  <Progress value={agentPredictions.sentimentMomentum.confidence * 100} />
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <Card className="bg-muted/50">
            ...
            <CardContent className="py-2">
              <div className="flex flex-col items-center justify-center">
                <div
                  className={`text-4xl font-bold uppercase ${getActionColor(finalDecision.action)} flex items-center`}
                >
                ...
                <div className="mt-4 w-full space-y-1">
                  ...
                  <Progress value={finalDecision.confidence * 100} className="h-3" />
